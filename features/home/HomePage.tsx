...
export function HomePage() {
  ...
  return <main>
    ...
    <section className="hero" id="top">
      <div className="heroCopy">
        ...
        <div className="searchPanel" id="discover">
          ...
          <div className="filters"><button><MapPin size={16}/> Location <ChevronDown size={14}/></button><button>₹ Budget <ChevronDown size={14}/></button><button>Mode <ChevronDown size={14}/></button><button>India / Abroad <ChevronDown size={14}/></button><button className="searchCta" onClick={()=>setSearched(true)}>Search</button></div>
    ...
    <section className="section proof"><div className="sectionHead"><div><p>Selected work</p><h2>Growth stories, grounded in delivery</h2></div></div><div className="proofGrid"><article className="proofMain"><span>EDTECH GROWTH</span><h3>2,500 leads generated, 300 converted</h3><p>For CIY, Kurunatics and Corizo, Admission Saarthi expanded brand visibility and reached previously untapped audiences.</p><a href="#">Read case study <ArrowRight size={16}/></a></article><article><span>DEHRADUN</span><h3>ITM & SIMS</h3><p>Lead generation and admissions-focused outreach highlighting academic and infrastructure strengths.</p></article><article><span>LUCKNOW</span><h3>BBS Degree College</h3><p>Brand positioning and local lead generation through targeted digital outreach.</p></article></div></section>
